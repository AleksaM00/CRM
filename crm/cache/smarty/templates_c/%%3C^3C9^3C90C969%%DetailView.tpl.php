<?php /* Smarty version 2.6.31, created on 2021-02-16 01:00:47
         compiled from cache/themes/SuiteP/modules/Bugs/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 108, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 101, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 491, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 491, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Bugs/DetailView.tpl', 491, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bugs'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bugs'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bugs'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Bugs'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field" type="int" field="bug_number" >

<?php if (! $this->_tpl_vars['fields']['bug_number']['hidden']): ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="product_category" >

<?php if (! $this->_tpl_vars['fields']['product_category']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="resolution" >
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="found_in_release" >

<?php if (! $this->_tpl_vars['fields']['found_in_release']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['found_in_release']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['found_in_release']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['found_in_release']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['found_in_release']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['found_in_release']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['found_in_release']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['found_in_release']['options'][$this->_tpl_vars['fields']['found_in_release']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="fixed_in_release" >

<?php if (! $this->_tpl_vars['fields']['fixed_in_release']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['fixed_in_release']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fixed_in_release']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['fixed_in_release']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['fixed_in_release']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['fixed_in_release']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['fixed_in_release']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['fixed_in_release']['options'][$this->_tpl_vars['fields']['fixed_in_release']['value']]; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="text" field="work_log" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['work_log']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['work_log']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['work_log']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html_entity_decode') : smarty_modifier_escape($_tmp, 'html_entity_decode')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span>
<?php endif; ?>
...
<div class="panel-body panel-collapse collapse in panelContainer" id="top-panel--1" data-id="LBL_BUG_INFORMATION">
<div class="tab-content">
<!-- TAB CONTENT -->
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Bugs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Bugs'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
