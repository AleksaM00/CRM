<?php /* Smarty version 2.6.31, created on 2021-02-16 00:29:50
...
:
		...
		<form id="upload_form" name="upload_form" method="POST" action="index.php?entryPoint=emailTemplateData&func=uploadAttachments" enctype="multipart/form-data"> <!-- action='AttachDocuments.php' -->
			...
			<div id="upload_div">
				...
				<input type="button" name="add_doc" id="add_doc" onclick="selectDoc();" value='<?php echo $this->_tpl_vars['MOD']['LBL_SUITE_DOCUMENT']; ?>
' class="button" />
