<?php /* Smarty version 2.6.31, created on 2021-02-16 00:34:18
         compiled from cache/themes/SuiteP/modules/ProspectLists/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 48, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 103, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 64, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 85, false),array('function', 'counter', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 110, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 148, false),array('block', 'minify', 'cache/themes/SuiteP/modules/ProspectLists/EditView.tpl', 101, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="list_type"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_DOMAIN_NAME">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<label for="domain_name"><div id="domain_label_div"><?php echo $this->_tpl_vars['MOD']['LBL_DOMAIN']; ?>
</div></label>

<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="domain_name"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>

<div id="domain_name_div"><input tabindex="0"  name="domain_name" id="domain_name" maxlength="255" type="text" value="<?php echo $this->_tpl_vars['fields']['domain_name']['value']; ?>
"></div>
</div>
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'name\', \'varchar\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'list_type\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_BY','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'domain_name\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DOMAIN_NAME','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'entry_count\', \'int\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ENTRIES','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'marketing_id\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MARKETING_ID','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'marketing_name\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MARKETING_NAME','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'ProspectLists','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'ProspectLists','for_js' => true), $this);?>
